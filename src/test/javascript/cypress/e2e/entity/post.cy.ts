...
describe('Post e2e test', () => {
  ...
  const postSample = {
    title: 'republican before as',
    content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=',
    date: '2024-12-23T01:48:14.965Z',
  };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      cy.get(`[data-cy="title"]`).type('amid');
      cy.get(`[data-cy="title"]`).should('have.value', 'amid');
      ...
      cy.get(`[data-cy="date"]`).type('2024-12-22T12:15');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2024-12-22T12:15');
